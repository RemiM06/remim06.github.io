var map = L.map('map').setView([43.7, 7.26], 10);
    ...
    var geojsonUrl = 'https://raw.githubusercontent.com/your-username/your-repo/main/geojson-data.json'; // Remplacez par votre propre URL GeoJSON ou une source valide
